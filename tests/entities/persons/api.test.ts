...
import { searchPersons, getTrayectoria } from '../../../src/entities/persons/api';
  ...
  it('searchPersons hace POST a /personas/criterios con el body correcto', async () => {
    ...
    expect(http.authedRequest).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        method: 'POST',
        body: JSON.stringify({ tpoNacionalidad: 'C', nroDocumentoIdent: '00000000', txtTotalNames: '' }),
      }),
    );
  });
