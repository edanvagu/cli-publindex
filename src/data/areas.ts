...
export function existeArea(codigo: string): boolean {
  return flatMap.has(codigo);
}

export function getNombreArea(codigo: string): string | undefined {
  return flatMap.get(codigo)?.nombre;
}

export function getPadreArea(codigo: string): string | null | undefined {
...
export function getAreasDeGranArea(codGranArea: string): { codigo: string; nombre: string }[] {
...
export function getSubareasDeArea(codArea: string): { codigo: string; nombre: string }[] {
...
export function areaPerteneceAGranArea(codArea: string, codGranArea: string): boolean {
  return getPadreArea(codArea) === codGranArea;
}

export function subareaPerteneceAArea(codSubarea: string, codArea: string): boolean {
  return getPadreArea(codSubarea) === codArea;
}
